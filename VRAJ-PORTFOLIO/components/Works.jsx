...
function ProjectCard({
  ...
  tiltMaxAngleX={10}
  tiltMaxAngleY={10}
  className="relative p-[2px] rounded-2xl sm:w-[370px] w-full min-h-[590px] animated-border"
>
  <div className="dark:bg-bgSecondaryDark bg-bgSecondaryLight rounded-[1rem] h-full w-full p-5 transition-all duration-300">
